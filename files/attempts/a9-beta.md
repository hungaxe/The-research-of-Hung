...
Việc nói về **"bất kỳ"** (so sánh **bất kỳ 2 biểu thức bất kỳ**) ở trên, thực tế tôi cũng đang phân vân không biết giới hạn sẽ nằm ở đâu, tuy nhiên hiện nay chúng ta đã có Halting Problem từ Turing & nhiều thứ khác có thể giúp; Thực tế ngay cả khi nếu **2 biểu thức bất kỳ** là phạm vi không thể, chúng ta vẫn có thể giới hạn lại; Ý tôi không hẳn là vậy, tại vì chúng ta có thể tạo ra nhiều môi trường, mỗi môi trường thì có phạm vi của biểu thức khác nhau, vậy tức là chúng ta vẫn sẽ có "2 biểu thức bất kỳ mà chúng ta quan tâm" trong hệ thống của chúng ta ? ;
